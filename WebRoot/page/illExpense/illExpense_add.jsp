...
<%	
	...
	PayRecord paylist = (PayRecord)request.getAttribute("payrecode");
	...
	<div class="panel admin-panel">
		...
		<div class="body-content">
			<form id="form-add" method="post" class="form-x"
				action="<%=path%>/system/IllExpenseServlet?m=add">
				
				
					<div class="form-group">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<%=selectyear %>年度慢性病报销封顶线：<span  style="color: red"><%=policy.getCeiling() %></span>
						<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<%=selectyear %>年度慢性病报销比例：<span  style="color: red"><%=policy.getRatio() %></span>
				</div>
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="<%=paylist.getJoinNum() %>" name="nongheCard" readonly="readonly"
