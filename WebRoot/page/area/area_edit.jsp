...
<div class="panel admin-panel">
 ...
 <form id="form-add" method="post" class="form-x"
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" readonly="readonly" class="input w50" value="<c:if test="${area.grade == '1' }">县</c:if><c:if test="${area.grade == '2' }">镇</c:if><c:if test="${area.grade == '3' }">村</c:if><c:if test="${area.grade == '4' }">组</c:if>" 
