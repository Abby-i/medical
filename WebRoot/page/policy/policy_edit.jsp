  ...
  <div class="body-content">
    <form id="form-addrole" method="post" class="form-x" action="<%=path%>/system/PolicyServlet?m=edit">  
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="${policy.ceiling }" name="ceiling" data-validate="required:必填项" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="${policy.ratio }" name="ratio" data-validate="required:必填项" />
          <div class="tips"></div>
        </div>
      </div>
      </div>
