...
%>
<%
	PayStantard payStantard = (PayStantard)request.getAttribute("payStantard");
 %>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
	...
	<div class="panel admin-panel">
		...
		<div class="body-content">
			<form id="form-add" method="post" class="form-x"
				action="<%=path%>/system/PayStantardServlet?m=edit">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="<%=payStantard.getAnnual() %>" name="annual"
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="<%=payStantard.getAccount() %>" name="account" placeholder="单位：元"
							data-validate="required:此项不能为空" />
						<div class="tips"></div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="field">
						<input  id="d4321" type="text" class="input w50" value="<%=payStantard.getStartTime() %>" name="startTime"
				...
				<div class="form-group">
					...
					<div class="field">
						<input id="d4322" type="text" class="input w50" value="<%=payStantard.getEndTime() %>" name="endTime"
