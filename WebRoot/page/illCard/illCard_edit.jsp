...
<%	
 ...
 %>
 <%
	IllCard card =(IllCard) request.getAttribute("card");
 %>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
		...
		<div class="body-content">
			...
			<%-- 	<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="field">
						<input id="nongheCard" type="text" class="input w50" value="<%=card.getIdCard() %>" name="nongheCard" readonly="readonly"
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="<%=card.getIdCard() %>" name="idCard" readonly="readonly"
