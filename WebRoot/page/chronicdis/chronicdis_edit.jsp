...
<%
 ...
 Chronicdis model =new Chronicdis(id);
%>
...
<body>
	...
	<div class="panel admin-panel">
		...
		<div class="body-content">
			<form id="form-add" method="post" class="form-x"
				action="<%=path%>/system/ChronicdisServlet?m=edit">
	...
	<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="<%=model.getPycode() %>" name="pycode"
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="<%=model.getWbcode() %>" name="wbcode"
