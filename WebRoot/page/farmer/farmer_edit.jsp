	...
	<div class="panel admin-panel">
		...
		<div class="body-content">
			<form id="form-add" method="post" class="form-x"
				action="<%=path%>/system/FarmerServlet?m=edit">
				...
				<div class="form-group">
					...
					<div class="field">
						...
						<input type="text"  readonly="readonly" class="input w50" value="${farmer.farmerid }" name="farmerid" 
				...
				<div class="form-group">
					...
					<div class="field">
						 <input type="text" class="input w50" value="${farmer.farmername }" name="farmername"
